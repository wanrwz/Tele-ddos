const net = require("net");
 ...
 if (process.argv.length < 7){console.log('example: node MIX.js <host> <time> <rps> <threads> <proxyfile>'); process.exit();}
 const headers = {};
...
`);
        ...
        console.log("𝐖𝐞𝐛𝐬𝐢𝐭𝐞/𝐓𝐚𝐫𝐠𝐞𝐭: " + process.argv[2]);
        console.log("𝐓𝐢𝐦𝐞𝐬: "+ process.argv[3]);
        console.log("𝐑𝐏𝐒: "+ process.argv[4]);
        console.log("𝐓𝐡𝐫𝐞𝐚𝐝𝐬: "+ process.argv[5]);
        console.log("𝐏𝐫𝐨𝐱𝐲𝐟𝐢𝐥𝐞: "+ process.argv[6]);
      } else {
